                                ...
                                <div className="relative">
                                    ...
                                    {dropdownOpen && (
                                        <div className="absolute right-0 mt-2 w-48 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                                            ...
                                            {/* ===== BUTTON ĐÃ SỬA LOGIC ROLE ===== */}
                                            <button
                                                // Cập nhật logic onClick
                                                onClick={() => {
                                                    setDropdownOpen(false);
                                                    if (userRole === 'teacher') {
                                                    ...
                                                    // Không làm gì cả nếu là admin
                                                }}
                                                // Thêm thuộc tính disabled nếu là admin
                                                disabled={userRole === 'admin'}
                                                // Thêm class để làm mờ nút và đổi con trỏ chuột khi bị disabled
