...
import api from '../../utils/api'; // Đảm bảo đường dẫn này là chính xác
...
const GuestViewCourseDetail = () => {
  ...
  useEffect(() => {
    const fetchCourseDetail = async () => {
      ...
      try {
        ...
        setCourse(DEFAULT_COURSE); // Reset về mặc định nếu có lỗi
      } finally {
        setLoading(false);
      }
    };
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Header Banner Section - Lấy cảm hứng từ ảnh mẫu */}
      <div className="relative pt-20 pb-40 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-purple-500 to-purple-800 text-white overflow-hidden">
        ...
        {/* Placeholder cho hình ảnh lớn/minh họa (tham khảo ảnh mẫu) */}
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="lg:w-2/3 bg-white p-8 rounded-xl shadow-2xl">
            ...
            <div className="text-gray-700 leading-relaxed space-y-4">
                ...
                {/* Giả định mô tả được render là HTML hoặc cần ngắt dòng đơn giản */}
                <p>{course.description}</p>

                {/* Phần tiêu chuẩn hóa từ ảnh mẫu (Giả định) */}
            ...
            {/* Chia nhỏ phần mục lục hoặc giáo viên nếu có */}
