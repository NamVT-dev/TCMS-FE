...
const TeacherClassDetail = () => {
  ...
  return (
    <div className="container mx-auto p-4 md:p-6">
      ...
      {/* --- THAY ĐỔI: Chuyển layout thành 1 CỘT --- */}
      {/* Xóa "lg:grid-cols-3" và các class "lg:col-span-*" */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pr-2">
                  {enrollments.map((enroll) => (
                    <div key={enroll._id} className="py-3 px-4 flex items-center space-x-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                      ...
                      <div>
                        <p className="font-medium text-gray-800">{enroll.student?.profile?.fullname || 'Chưa cập nhật'}</p>
                        <p className="text-sm text-gray-500">{enroll.student?.email || 'N/A'}</p>
                      </div>
                    </div>
                  ))}
                </div>
