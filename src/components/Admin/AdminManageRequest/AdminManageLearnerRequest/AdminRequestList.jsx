...
const AdminRequestList = () => {
    ...
    const getStatusBadge = (status) => {
        switch (status) {
            ...
            case "processed": return <span className="px-2 py-1 bg-purple-100 text-purple-800 rounded-full text-xs font-medium flex items-center w-fit"><CheckCircle className="w-3 h-3 mr-1"/> Đã xử lý</span>;
                                    ...
                                    <tr key={req._id} className="hover:bg-gray-50">
                                        ...
                                        <td className="px-6 py-4">
                                            {req.course ? (
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-xs text-gray-500">{req.course.level}</span>
                                                </div>
                                            ) : (
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="text-sm text-gray-600">
                                                <p><span className="font-semibold text-xs">Ngày:</span> {formatDays(req.preferredDays)}</p>
                                                <p><span className="font-semibold text-xs">Ca:</span> {req.preferredShifts?.join(", ")}</p>
                                            </div>
                                        </td>
