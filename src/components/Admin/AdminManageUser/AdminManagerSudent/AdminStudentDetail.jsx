...
import {
    ...
    GraduationCap, Target, Clock, X, Flag
} from "lucide-react";
                        ...
                        >
                            <div className="bg-gradient-to-r from-purple-50 to-white px-6 py-5 border-b border-gray-100 flex justify-between items-start">
                                <div className="flex items-center gap-4">
                                    <img
                                        src={selectedStudent.photo || getAvatarUrl(selectedStudent.name)}
                                        alt={selectedStudent.name}
                                        className="w-16 h-16 rounded-full object-cover border-2 border-white shadow-md"
                                        onError={(e) => {
                                            e.target.onerror = null;
                                            e.target.src = getAvatarUrl(selectedStudent.name);
                                        }}
                                    />
                                    <div>
