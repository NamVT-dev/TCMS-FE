  ...
  const [students] = useState([
    {
      ...
      phone: "0901234567",
      courses: "IELTS Foundation, TOEIC Beginner",
      dob: "15/03/2005",
      currentClass: "IELTS-A1-01"
    },
    {
      id: 2,
      name: "Trần Thị Bình",
      ...
      phone: "0912345678",
      courses: "TOEIC Advanced",
      dob: "22/07/2004",
      currentClass: "TOEIC-B2-03"
    },
    {
      id: 3,
      name: "Lê Hoàng Cường",
      ...
      phone: "0923456789",
      courses: "IELTS Intermediate",
      dob: "10/11/2005",
      currentClass: "IELTS-B1-02"
    },
    {
      id: 4,
      name: "Phạm Minh Đức",
      ...
      phone: "0934567890",
      courses: "IELTS Advanced, Speaking Practice",
      dob: "05/01/2004",
      currentClass: "IELTS-C1-01"
    },
    {
      id: 5,
      name: "Võ Thị Em",
      ...
      phone: "0945678901",
      courses: "TOEIC Foundation",
      dob: "18/09/2006",
      currentClass: "TOEIC-A2-02"
    }
  ]);
      ...
      <div className="bg-white rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="bg-gray-50 px-6 py-4 flex items-center justify-between border-t border-gray-200">
          <div className="text-sm text-gray-700">
            Hiển thị <span className="font-medium">1</span> đến <span className="font-medium">{filteredStudents.length}</span> trong tổng số <span className="font-medium">{students.length}</span> học viên
          </div>
