...
import { Loader2, Save, X, Upload, User, CheckSquare, Phone, Mail, Lock, Check, HelpCircle, Info, ArrowDown } from 'lucide-react';
                                        ...
                                        {allCategories.map((cat) => {
                                            ...
                                            return (
                                                <div key={cat._id} className={`border rounded-lg transition-all ${isChecked ? 'border-purple-500 bg-purple-50/10 shadow-sm' : 'border-gray-200 hover:border-purple-200'}`}>
                                                    ...
                                                    {isChecked && (
                                                        <div className="p-4 pt-0 pl-11 border-t border-gray-100/50 animate-in slide-in-from-top-1 duration-200">
