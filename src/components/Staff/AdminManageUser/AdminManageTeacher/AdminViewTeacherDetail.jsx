    ...
    return (
        <div className="bg-gray-50 min-h-screen pb-10">
            ...
            <div className="bg-white border-b border-gray-200 sticky top-0 z-10 px-6 py-3 flex justify-between items-center shadow-sm">
                <Link to="/staff/users/teachers" className="flex items-center text-gray-600 hover:text-purple-700 font-medium transition-colors">
                    <ArrowLeft className="h-5 w-5 mr-2" />
                    Quay lại danh sách
                </Link>
                <button
                    onClick={() => navigate(`/staff/users/teachers/edit/${id}`)}
