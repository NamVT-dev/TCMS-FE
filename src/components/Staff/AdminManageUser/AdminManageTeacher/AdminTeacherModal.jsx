    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (isEditMode) {
                ...
                if (!newId) {
                    console.error("Không tìm thấy ID trong response tạo mới:", res);
                ...
                <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden transform transition-all duration-200 scale-100">
                    ...
                    <div className="px-6 py-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-0.5">{isEditMode ? 'Chỉnh sửa thông tin và kỹ năng' : 'Tạo tài khoản và thiết lập kỹ năng'}</p>
                        </div>
