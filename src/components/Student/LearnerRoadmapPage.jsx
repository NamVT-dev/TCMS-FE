...
const inputClass = "mt-1 block w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent disabled:bg-gray-100 disabled:text-gray-400 cursor-pointer disabled:cursor-not-allowed";
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-xl border border-gray-200 space-y-8">
                        ...
                        <section className="pt-4">
                            <div className="flex justify-between items-center mb-6 pb-3 border-b-2 border-purple-100">
                                ...
                                {existingTarget && !isEditing && !isNotTested && !isFetchingDetail && (
                                    <button
                            ...
                            {isNotTested ? (
                                <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-6 flex flex-col md:flex-row items-center gap-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                    <div className="p-4 bg-white rounded-full shadow-sm flex-shrink-0">
                                    ...
                                    <div className="text-center md:text-left flex-1">
                                        ...
                                        <p className="text-gray-700 mb-2">
                                            Học viên chưa có điểm bài kiểm tra năng lực. Để hệ thống có thể xây dựng lộ trình chính xác, vui lòng hoàn thành bài kiểm tra trước.
                                        </p>
                                        <p className="text-sm text-gray-500 font-medium italic">
                                            * Hệ thống đã gửi link bài kiểm tra vào email đăng ký của học viên.
                                        </p>
                                    </div>
                                </div>
                            ) : (
                                                            ...
                                                            return (
                                                                <div key={index} className="flex md:flex-col items-center relative group w-full md:flex-1">
                                                                    <div className={`w-12 h-12 rounded-full flex items-center justify-center border-4 shadow-sm z-10 transition-transform hover:scale-110 duration-300 flex-shrink-0 bg-white
                                                                        ${isStart ? 'border-blue-500 text-blue-600' : isEnd ? 'border-purple-600 text-purple-600 shadow-purple-100' : 'border-purple-300 text-purple-400'}`}>
                                                                        {isStart ? <Star size={20} fill="currentColor" /> : isEnd ? <Flag size={20} fill="currentColor" /> : <BookOpen size={16} />}
                                                                    </div>
                                                                    ...
                                                                    {!isEnd && <div className="md:hidden absolute left-6 top-12 bottom-[-24px] w-0.5 bg-gray-200 -z-10"></div>}
                                                                </div>
                                                            );
                                                        })}
                                                    </div>
